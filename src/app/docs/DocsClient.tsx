...
const FALLBACK_ORIGIN = 'https://oasisai.work';
        ...
        <div className="max-w-[1600px] mx-auto px-4 md:px-8 h-14 flex items-center gap-3">
          <Link href="/" className="flex items-center gap-2.5 shrink-0 group">
            <img
              ...
              alt="OASIS AI"
              className="w-7 h-7 object-contain transition-all group-hover:drop-shadow-[0_0_10px_rgba(124,214,255,0.6)]"
            />
          ...
          <a
            href="https://github.com/CC90210/oasis-vision"
            target="_blank"
...
docker compose up -d`}</Pre>
          ...
          <footer className="border-t border-white/[0.06] pt-6 pb-16 flex flex-wrap items-center gap-x-5 gap-y-2 text-[10px] font-mono text-[var(--text-muted)]">
            {[
              { href: 'https://github.com/CC90210/oasis-vision', label: 'GitHub' },
              { href: 'https://discord.gg/EPaFD5FFKf', label: 'Discord' },
              { href: 'https://x.com/soulsimplifai', label: 'X' },
              { href: 'https://github.com/CC90210/oasis-vision/issues', label: 'Report an issue' },
            ].map(l => (
              <a
                key={l.label}
                href={l.href}
