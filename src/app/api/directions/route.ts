...
/**
 * OASIS VISION — Turn-by-turn Directions API
 *
...
/** Minimal shapes of the upstream payloads — only the fields OASIS VISION reads. */
...
export async function GET(request: Request) {
  try {
    ...
    console.error('[OASIS] Directions error:', error);
