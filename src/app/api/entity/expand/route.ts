...
/**
 * Thin proxy to the OASIS VISION Intelligence Layer (oasis-vision-intel).
 *
 * In Docker: fetches from http://oasis-vision-intel:4000/resolve
...
export async function GET(req: Request) {
  ...
  try {
    ...
    console.error('[OASIS] Intel proxy error:', e instanceof Error ? e.message : e);
    return NextResponse.json(
