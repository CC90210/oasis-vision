  ...
  return (
    ...
    >
      <div className="h-[28px] overflow-hidden bg-[#0a0a0f]/95 border-t border-white/[0.06] flex items-center text-[10px] font-mono tracking-wider backdrop-blur-xl relative">
        ...
        {/* ── LEFT: Documentation ── */}
        {/* Upstream's Discord and X links lived here. They pointed at the
            original author's community, not ours, so they are removed rather
            than repointed — this is a private console, not a project homepage. */}
